...
type MetricsResponse struct {
	...
	WorktreeActionsAttempted int64          `json:"worktree_actions_attempted"`
	WorktreeActionsRejected  int64          `json:"worktree_actions_rejected"`
	WorktreeActionsRemoved   int64          `json:"worktree_actions_removed"`
	WorktreeActionsFailed    int64          `json:"worktree_actions_failed"`
}
